...
-- User 4 is the reviewer Telegram ID provided for testing.
...
VALUES
  ...
  (4, 522750318, 'task_reviewer', 'Reviewer', TRUE);
...
VALUES
  ...
  (5, 4, 'agent_reviewer_sales', 'Reviewer Sales Agent'),
  (6, 4, 'agent_reviewer_support', 'Reviewer Support Agent');
